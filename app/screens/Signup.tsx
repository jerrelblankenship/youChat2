...
const Signup = ({navigation}: NavigatingProperties) => {
  ...
  return (
    <SafeAreaView style={{backgroundColor: 'white',paddingHorizontal: 7}}>
            <View style={{marginTop: 24, width:'80%', justifyContent: 'center', alignItems: 'center'}}>
...
const styles = StyleSheet.create({
  input: {
    backgroundColor: '#b8c5ca', borderRadius: 10, paddingVertical: 10, paddingHorizontal: 15, marginTop: 5
  }
})
